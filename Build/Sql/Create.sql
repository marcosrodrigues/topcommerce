...
CREATE TABLE [dbo].[CONTAS_PAGAR](
	[ID] [int] IDENTITY(1,1) NOT NULL,
	[FORNECEDOR_CODIGO] [char](3) NOT NULL,
...
ALTER TABLE [dbo].[CONTAS_PAGAR] CHECK CONSTRAINT [FK_CONTAS_PAGAR_FORNECEDORES]
GO

CREATE TABLE [dbo].[CONTAS_RECEBER](
	[ID] [int] IDENTITY(1,1) NOT NULL,
	[CLIENTE_CODIGO] [char](6) NULL,
	[NOME_CLIENTE_AVULSO] [varchar](60) NULL,
	[VENCIMENTO] [date] NOT NULL,
	[VALOR] [float] NOT NULL,
	[OBSERVACOES] [text] NULL,
...
ALTER TABLE [dbo].[CONTAS_RECEBER] CHECK CONSTRAINT [FK_CONTAS_RECEBER_CLIENTES]
GO
