...
function Bematech_FI_VerificaZPendente( Status: string ): Integer; StdCall; External 'BEMAFI32.DLL';
...
function Bematech_FI_AtivaDesativaCorteProximoMFD( iFlag: Integer ): Integer; StdCall; External 'BEMAFI32.DLL';
...
function Bematech_FI_ArquivoMFDPath( cNomeArquivoOrigem: String; cNomeArquivoDestino: String; cDadoInicial: String; cDadoFinal: String; cTipoDownload: String; cUsuario: String; iTipoGeracao: integer; cChavePublica: String; cChavePrivada: String; iUnicoArquivo: integer ): Integer;  StdCall; External'BEMAFI32.DLL';
...
function Bematech_FI_MinutosEmitindoDocumentosFiscaisCV0909( cMinutos: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_NumeroCupomCV0909( cNumero: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_NumeroOperacoesNaoFiscaisCV0909( cNumero: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_NumeroSerieCV0909( cNumero: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_RetornoAliquotasCV0909( cAliquotas: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_RetornoImpressoraCV0909( iCAT: integer; iRET0: integer; iRET1: integer; iRET2: integer; iRET3: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VerificaFormasPagamentoCV0909( cFormar: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VerificaIndiceAliquotasIssCV0909( cIndices: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VerificaRecebimentoNaoFiscalCV0909( cRecebimentos: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VerificaTotalizadoresNaoFiscaisCV0909( cTotalizadores: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VersaoFirmwareCV0909( cVersao: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_TempoEmitindoOperacionalCV0909( cTempoEmitindo: string; cTempoOperacional: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AbreComprovanteNaoFiscalVinculadoCV0909( iSequencia: integer; cIndice: string; iQtdeParcela: integer; iNumeroParcela: integer; cCPF: string; cNome: string; cEndereco: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AbreCupomCV0909( cCPF: string; cNome: string; cEndereco: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AbreRecebimentoNaoFiscalCV0909( cCPF: string; cNome: string; cEndereco: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AbreRelatorioGerencialCV0909( cRelatorio: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AcionaGuilhotinaCV0909( iModo: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AcrescimoDescontoItemCV0909( cItem: string; cTipo: string; cModo: string; cValor: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_AcrescimoDescontoSubtotalCV0909( cTipo: string; cModo: string; cValor: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_CancelaAcrescimoDescontoItemCV0909( cTipo: string; cItem: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_CancelaAcrescimoDescontoSubtotalCV0909( cTipo: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_CancelaCupomCV0909( cCOO: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_CancelaCupomAtualCV0909: Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_DownloadMFCV0909( cNomeArquivo: string; cTipo: string; cDadoInicial: string; cDadoFinal: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_DownloadMFDCV0909( cNomeArquivo: string; cTipoDownload: string; cDadoInicial: string; cDadoFinal: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_DownloadSBCV0909( cNomeArquivo: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_EfetuaFormaPagamentoIndiceCV0909( cIndice: string; cValor: string; cParcelas: string; cDescricao: string; cCodigoPagamento: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_EfetuaRecebimentoNaoFiscalCV0909( cIndiceTotalizador: string; cValor: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_EstornoFormasPagamentoCV0909( cFormaOrigem: string; cFormaDestino: string; cValor: string; iSequenciaForma: integer; cMensagem: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_EstornoNaoFiscalVinculadoCV0909( cCPF: string; cNome: string; cEndereco: string; cCOO: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_FechaRecebimentoNaoFiscalCV0909( cInformacao: string; iGuilhotina: integer ): Integer; StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_FechaRelatorioGerencialCV0909( iGuilhotina: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_ImpressaoFitaDetalheCV0909( cTipo: string; cDadoInicial: string; cDadoFinal: string ): Integer; StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_LeituraMemoriaFiscalDataCV0909( cDataInicial: string; cDataFinal: string; cFlag: string ): Integer; StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_LeituraMemoriaFiscalReducaoCV0909( cReducaoInicial: string; cReducaoFinal: string; cFlag: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_LeituraMemoriaFiscalSerialDataCV0909( cDataInicial: string; cDataFinal: string; cFlag: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_LeituraMemoriaFiscalSerialReducaoCV0909( cReducaoInicial: string; cReducaoFinal: string; cFlag: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_ReducaoZCV0909( cData: string; cHora: string; iTransmite: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_ReimpressaoNaoFiscalVinculadoCV0909: Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_SangriaCV0909( cValor: string; cInformacao: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_SegundaViaNaoFiscalVinculadoCV0909: Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_SuprimentoCV0909( cValor: string; cInformacao: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_TerminaFechamentoCupomCV0909( cInformacao: string; iCupomAdicional: integer; iGuilhotina: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_UsaRelatorioGerencialCV0909( cTexto: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VendeItemCV0909( cCodigo: string; cDescricao: string; cAliquota: string; cQuantidade: string; iDecimalQtde: integer; cValor: string; cUnidadeMedida: string; iDecimalValor: integer; cModo: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_InterrompeLeiturasCV0909: Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_ImprimeRTDCV0909( cMensagem: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_BufferRespostaCV0909( cBuffer: string ): Integer;  StdCall; External 'BEMAFI32.DLL';
...
function Bematech_FI_ProgramaHorarioVeraoCV0909( iModo: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_NomeiaTotalizadorNaoSujeitoIcmsCV0909( iIndice: integer; cDescricao: string; cSituacao: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_ProgramaIdAplicativoCV0909( cID: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_NomeiaRelatorioGerencialCV0909( cIndice: string; cDescricao: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_ProgramaFormaPagamentoCV0909( cIndice: string; cDescricao: string; iVincula: integer ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_DadosUltimaReducaoCV0909( cDados: string ): Integer;  StdCall; External 'BEMAFI32.DLL';



function Bematech_FI_VendeItemArredondamentoMFD( Codigo: String; Descricao: String; Aliquota: String; UnidadeMedida: String; QtdFracionaria: String; VlrUnitario: String; Acrescimo: String; Desconto: String; Arredonda: String): Integer; StdCall; External 'BEMAFI32.DLL';
